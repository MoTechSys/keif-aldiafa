...
import { navLinks, getWhatsAppLink, PHONE, INSTAGRAM_URL } from '@/data/constants'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-[#F5F5DC]/60 text-sm leading-relaxed">
              منصة تجربة فاخرة تعكس جودة وفخامة خدمات الضيافة السعودية، توفر رحلة حسية متكاملة للزائر.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.id}>
                  <Link href={link.href} className="text-[#F5F5DC]/60 text-sm hover:text-[#B8860B] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
