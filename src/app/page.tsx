...
export default function Home() {
  ...
  // PWA Install Logic
  useEffect(() => {
    // Clear previous test data to ensure banner shows
          ...
          <div className="hidden md:flex items-center gap-2">
            {!isStandalone && (
              <motion.button
                ...
                className="px-4 py-2 rounded-full border border-[#B8860B]/50 text-[#B8860B] text-sm transition-all duration-200 hover:bg-[#B8860B]/10"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                📥 تثبيت التطبيق
